...
def friends(request):
            ...
            potential_friends = (
                ...
                .annotate(
                    common_restaurant_count=Count(
                        ...
                        filter=Q(
                            userrestaurantslist__restaurant_id__in=user_restaurants
                        ),
                    )
                )
    ...
    # friend_request
        ...
        # 친구 신청
            ...
            return Response(
                {"message": "친구 요청을 보냈습니다."}, status=status.HTTP_201_CREATED
            )
        ...
        # 친구 수락
            ...
            reverse_friend_relation = Friend.objects.create(
    ...
    # delete_friend
        ...
        friend.delete()
        reverse_friend = get_object_or_404(
            Friend, user__id=friend_id, friend=request.user
        )
